import { loadComponentsFromDirectory, validateTool, validateResource, validatePrompt } from '../../helpers/component-loader.js';
import type { ToolDefinition, ResourceDefinition, PromptDefinition, AutoloadConfig } from '../interfaces.js';
