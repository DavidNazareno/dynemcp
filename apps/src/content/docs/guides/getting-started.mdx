...
```bash
pnpx create-dynemcp@latest my-project
```
...
pnpx create-dynemcp@latest my-agent --template default-stdio --yes

# Use default-http template
pnpx create-dynemcp@latest my-server --template default-http --yes

# Skip dependency installation
pnpx create-dynemcp@latest my-agent --template default-http --yes --skip-install
```
